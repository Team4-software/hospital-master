                ...
                <li>
                    <div>
                        <c:if test="${sessionScope.patient != null}">
                            ...
                            <a class="navbar-brand1" style="font-size: 12px;" href="<%=request.getContextPath()%>/patient/register.jsp"><strong>注册</strong></a>
                            <a class="navbar-brand1" style="font-size: 12px;" href=""><strong><font color="#fff">欢迎您, ${sessionScope.patient.name}</font></strong></a>
                            <a class="navbar-brand1" style="font-size: 12px;" href="<%=request.getContextPath()%>/logout"><strong>注销</strong></a>
                        </c:if>
                        <a class="navbar-brand1" style="font-size: 12px;" href="<%=request.getContextPath()%>/patient/help.jsp"><strong>帮助中心</strong></a>
                    </div>
                </li>
            </ul>
        </div>
